...
function Fourthsection() {
	 useEffect(() => {
        ...
        let colorInterp = interpolate(colorArr);
  ...
  return (
    <>
    <div className="mainfour" data-aos="zoom-in">
    <h1 className="headtext">Dynamic Animation <br /> Mastery: Pro Tips and Techniques</h1>
     
      <div className="layeredanim">
